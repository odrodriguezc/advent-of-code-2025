...
module AdventOfCode
  ...
  #   runner = AdventOfCode::Runner.new(day: 1, part: 1)
  #   result = runner.run
  #
  ...
  class Runner
    ...
    def run
      input = AdventOfCode::Loaders::Input.load(@day, use_fixture: @use_fixture) # Pass the flag to the loader
      solver = AdventOfCode::Loaders::Solver.load(@day, input)
      @result = solver.solve(part: @part)
      @drawer = AdventOfCode::Loaders::Drawer.load(@day, solver) if @visualize
    end
  end
end
